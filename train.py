...
def train(args):
    ...
    if "aug_func" in agent_kwargs.keys():
        if args.algo == "sar":
            log_file = f'-{args.env_name}-{args.algo}({args.aug_type})(adv{args.adv_coef})(val{args.val_sim_coef})-seed{args.seed}-{args.tag}'
        else:
            log_file = f'-{args.env_name}-{args.algo}({args.aug_type})-seed{args.seed}-{args.tag}'
    else:
        log_file = f'-{args.env_name}-{args.algo}-seed{args.seed}-{args.tag}'
